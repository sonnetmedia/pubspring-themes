...
<?php  ///// OVERLOOK CUSTOMIZATION    ?>	
	
<?php $publisher_site_link = get_field('sm_publisher_site_link'); ?>

<?php if ( $publisher_site_link ) { ?>


<li><a href="http://overlookpress.com/<?php echo $publisher_site_link; ?>" title="Overlook Press"><img src="http://readswordsandsandals.com/files/2013/02/logo-overlook.jpg" alt="Overlook Press" style="height: 35px;" /></a></li>


<?php  }    ?>	
	
	<?php  ///// END OVERLOOK CUSTOMIZATION    ?>	
