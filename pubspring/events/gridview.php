...
?>	
	<div id="tribe-events-content" class="grid">
      ...
      <title><?php wp_title() ?></title>
		...
		<span class='tribe-events-calendar-buttonsTK'> 
			<a class='btn tribe-events-button-off' href='<?php echo tribe_get_listview_link(); ?>'><?php _e('Event List', 'tribe-events-calendar')?></a>
		</span>
