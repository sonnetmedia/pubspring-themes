<?php 
	...
	get_template_part('loop', 'short_bio'); 
?>


	<?php //remove this </div> because it looks like there are too many ?>	 <!-- End Main row -->
...
?>
		...
		<div class="row">
			...
			<?php 
			wp_nav_menu(array('theme_location' => 'utility_navigation', 'container' => false, 'menu_class' => 'five columns footer-nav')); 
			?>
		</div>		
