...
<div class="modal-body">
	...
	<div style="width: 200px;" class="flow_left hidden-phone">
		<img src="<?php the_field('cover_image'); ?>" alt="" class="shadow" width="190" style="width:190px;max-width:100%;"  />
	</div>
...
<div id="buy_books_<?php the_ID(); ?>" class="hidden-desktop hidden-tablet hide-on-portrait" style="background-color:#FFF;margin-top:.5em;">
	<div class="modal-header">
		<a class="close" data-dismiss="modal" >&times;</a>
		<h3>Buy <em><?php the_title(); ?></em> from these booksellers</h3>
	</div>
...
<div class="modal-body">
	...
	<div style="width: 200px;" class="flow_left hidden-phone">
		<img src="<?php the_field('cover_image'); ?>" width="190" style="width:190px;max-width:200px;" alt="" class="shadow" />
	</div>
