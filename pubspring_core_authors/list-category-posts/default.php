...
$lcp_display_output .= '<ul class="lcp_catlist upcoming">';
...
// if( !empty( $single->post_content) ) { $lcp_display_output .= " <span class='inline label label-important metadata small' style='font-size:70%;font-weight:400;color:white;'>Full Text</span>"; }
