<?php get_header(); ?>
<?php //template name: Home - Stacked Rows with box for social ?>
...
<!--										&rdquo;--></em>
		...
		<section style="margin-top: 1.5em;border-top: 1px solid #ddd;">
		<div class="span6">
			<?php
		...
		<div class="addthis_toolbox addthis_32x32_style addthis_default_style">
			<a class="addthis_button_facebook_follow" addthis:userid="rangeley.wallace"></a>
			<a class="addthis_button_twitter_follow" addthis:userid="RangeleyWallace"></a>
		</div>
