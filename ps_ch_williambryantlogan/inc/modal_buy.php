...
<div id="modal_<?php the_ID(); ?>" class="modal hide fade" style="margin-top: 6em;">
...
<br />
	...
	<br />
		<li class="powells">
			<a href="http://www.powells.com/biblio/<?php the_field('isbn'); ?>"  title="<?php the_title(); ?>" target="_blank">
...
<div id="buy_books_<?php the_ID(); ?>" class="hide-on-desktops hide-on-tablets" style="background-color:#FFF;margin-top:.5em;">
	<div class="modal-header">
		<a class="close" data-dismiss="modal" >&times;</a>
		<h3>Buy <em><?php the_title(); ?></em> from these booksellers</h3>
	</div>
