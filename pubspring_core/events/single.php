...
<div class="entry">
	...
	<?php  //put related blog posts here    ?>	
...
<?php  // CONTENT AND MAP LINKS WERE HERE    ?>


<div class="navlink previous">Previous Event: <?php tribe_previous_event_link();?></div>

<div class="navlink next">Next Event: <?php tribe_next_event_link();?></div>
